...
source("C:/Users/lamps/Documents/Research/Code/3.0_Functions_robust_SE_noX1.R")
...
alpha = 0.05
reps = 1000
which.betas = c(2,3,4) # controls which of the X1 - X10 covariates to keep in the estimations
...
for (n in ns) {
  for (delta in deltas) {
    ...
    # name boxplot file
    outfile = paste("C:/Users/lamps/Documents/Research/Output/Plots/noX1_boxplot", n, delta , ".pdf", sep="_")
...
write.csv(results, "C:/Users/lamps/Documents/Research/Output/Results_03052020_noX1.csv")
