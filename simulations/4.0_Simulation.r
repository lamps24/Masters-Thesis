...
for (n in ns) {
  for (delta in deltas) {
    ...
    # name boxplot file
    outfile = paste("C:/Users/lamps/Documents/Research/Output/Plots/boxplot", n, delta , ".pdf", sep="_")
...
write.csv(results, "C:/Users/lamps/Documents/Research/Output/Results_04082020.csv")
